...
public class UserJPA_DAO_test {
	...
	Person user1, user2, blankuser, user3;
	...
	public void setup(){
		...
		user3=new Person();
		user3.setFirstName("Guy");
		user3.setLastName("Fawkes");
		user3.setPassword("password");
		user3.setUserName("sequenceUser4");
...
//	
	@Test
	public void testAutoGeneratedSequenceCreate(){
		try {
			dao.create(user3);
		} catch (StorableNotFoundException e) {
			// TODO Auto-generated catch block
