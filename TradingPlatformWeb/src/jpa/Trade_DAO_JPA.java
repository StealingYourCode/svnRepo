...
public class Trade_DAO_JPA implements IStorage<Trade, Integer, Integer> {
	...
	public ArrayList<Trade> readTradeByShareholderId(Integer id) {
		...
		Query query = em.createNativeQuery(
				"SELECT * FROM TRADE WHERE BUYER_ID = '" + id
						+ "'  OR SELLER_ID='" + id + "'", Trade.class);
		
		tradeList = query.getResultList();
		return (ArrayList<Trade>) tradeList;
