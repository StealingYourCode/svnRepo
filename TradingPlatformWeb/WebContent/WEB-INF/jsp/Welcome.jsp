...
<body>
	...
	<div id='loginButtons'>
		<button type="button" id='loginButton'
			onclick="location.href='../StaticStuff/HTML/loginPage.html'">Swtich
			User</button>
		&nbsp&nbsp&nbsp
		<button type="button" id='registerButton'
			onclick="location.href='RegisterPage.html'">Register</button>
	</div>
	...
	<div id='firstText'>
		...
		<form role="form" name="viewRequstForm" action="ViewRequest"
			method="post">
			<button type="submit" class="btn btn-default" id='learnMoreButton1'>View</button>
		</form>
	</div>
	...
	<div id='secondText'>
		...
		magic of TP.
		<form role="form" name="makeRequestform"
			action="StaticStuff/HTML/Request.html" method="post">
			<a href="Request"><button type="submit" id='learnMoreButton2'>Request</button>
		</form>
		</a>
	</div>
	...
	<div id='thirdText'>
		...
		<form role="form" name="viewTradesForm" action="ViewTrades"
			method="post">

			<button type="submit" class="btn btn-default" id='learnMoreButton3'>View</button>
			</form>
	</div>
	<div id='fourthText'>
		<h1>TP Services</h1>
	...
	<div id='insideText'>
		...
		<button type="button" id='makeAccountButton'
			onclick="location.href='RegisterPage.html'">OPEN AN ACCOUNT</button>

	</div>
	<hr id='line3'>
	<div id='icons'>
		<img id='facebook'
			src="/TradingPlatformWeb/StaticStuff/images/facebookIcon.png"
			width="32" height="28"> <img id='facebook'
